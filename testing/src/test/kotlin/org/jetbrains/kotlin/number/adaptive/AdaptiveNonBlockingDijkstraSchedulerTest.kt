...
// * @since 20.04.2022
// */
//internal class AdaptiveNonBlockingDijkstraSchedulerTest {
//    @Test
...
//        }
//
//        AdaptiveNonBlockingDijkstraScheduler(nodesList, 0, 1, stealSize = 1, pSteal = 1.0, retryCount = 3).use {
...
//        a.addEdge(2, 4)
//
//        AdaptiveNonBlockingDijkstraScheduler(nodesList, 0, 4).use { it.waitForTermination() }
//
//        assertEquals(0, a.distance)
//        assertEquals(2, b.distance)
//        assertEquals(3, c.distance)
...
//        clearNodes(nodes)
//
//        AdaptiveNonBlockingDijkstraScheduler(nodes, 0, 4).use {
//            it.waitForTermination()
//            it
//        }
//
...
//        clearNodes(nodes)
//
//        AdaptiveNonBlockingDijkstraScheduler(nodes, 0, 8, pSteal = 0.0625, stealSize = 8).use {
//            it.waitForTermination()
//        }
//
//        val parallelResult = nodes.map { it.distance }
...
//
//        val scheduler = AdaptiveNonBlockingDijkstraScheduler(nodesList, from, 4, pSteal = 0.25).use { scheduler ->
