...
import org.jetbrains.kotlin.number.scheduler.calc.AdaptiveBfsSchedulerMetrics
...
open class AdaptiveBfsSMQMetricsBenchmark {

    @Benchmark
    fun testSequenceKS(config: Config) {
        val scheduler = AdaptiveBfsSchedulerMetrics(
            config.nodes,
            startIndex = 0,
