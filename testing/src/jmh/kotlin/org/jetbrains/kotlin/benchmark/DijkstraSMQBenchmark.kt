...
//        @Param("1",  "4", "16",  "64",  "256",  "1024")
        ...
        fun printAll() {
            ...
            val tasksLowerThanStolenIncludingOurEmptiness: Double = results.sumOf { it.tasksLowerThanStolenIncludingOurEmptiness } / size
