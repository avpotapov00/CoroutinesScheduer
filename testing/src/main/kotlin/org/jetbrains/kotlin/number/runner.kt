...
private fun runDijkstra(nodes: List<IntNode>, config: Config): Double {
    return PriorityLongDijkstraScheduler(
        nodes,
        startIndex = 0,
        ...
        it.successSteals.value / it.retrievals.value.toDouble()
    }
}

private fun runBFS(nodes: List<BfsIntNode>, config: Config): Double {
