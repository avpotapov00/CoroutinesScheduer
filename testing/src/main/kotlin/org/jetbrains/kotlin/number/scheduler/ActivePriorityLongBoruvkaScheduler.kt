 ...
 * @since 16.04.2022
 */
class ActivePriorityLongBoruvkaScheduler(
            ...
            while (!terminated) {
                if (finishPhaser.phase % 2 == 0) {
                    ...
                    while (true) {
                        ...
                        finishPhaser.arrive()
                        while (finishPhaser.phase % 2 == 0 && !terminated) {
                        }
                        break
                    }
                } else { // 2 phase
                    ...
                    finishPhaser.arrive()
                    while (finishPhaser.phase % 2 == 1 && !terminated) {
                    }
                }
            }
        }
    ...
    fun parallelBoruvkaExp(): Pair<ActivePriorityLongBoruvkaScheduler, Set<EdgeIndexed>> {
